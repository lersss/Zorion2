...
26. **Impact map (`docs/impact_map.json`, реестр каскадных влияний, ведёт @manager, идея 83a).** Перед правкой сущности из реестра — сверься с ним: «меняем X → смотрим на Y».
