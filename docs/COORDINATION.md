...
|---|---|---|
| — | нет активных меток. Последние: «ступени поселения» (коммиты `4c8136b`, `9d045ab`), «переключатель масштаба единицы — студия» (коммит `3628095`); витрина поселения (блок арифметики) — не начата | — |
