...
// v7 (спека 2026-09-23 §4.6.5): заполнение color у 11 биомов биосферы (ЧК2)
// меняет и картинку планеты с орбиты — без бампа дисковый кэш
// (planet|mode|size|v6) показал бы старый цвет («орбита старая, прогулка новая»).
// v6 — тот же бамп для 10 биомов литосферы (ЧК1, §4.5.5); v5 — 4 образца (§2.5).
const ImageGenVersion = "v7"
