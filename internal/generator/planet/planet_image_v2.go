...
// v6 (спека 2026-09-23 §4.5.5): заполнение color у 10 биомов литосферы (ЧК1)
// меняет и картинку планеты с орбиты — без бампа дисковый кэш
// (planet|mode|size|v5) показал бы старый цвет («орбита старая, прогулка новая»).
// v5 — тот же бамп для 4 образцов (§2.5).
const ImageGenVersion = "v6"
