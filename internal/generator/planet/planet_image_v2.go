...
// v5 (спека 2026-09-23 §2.5): заполнение color у биомов-образцов меняет и
// картинку планеты с орбиты — без бампа дисковый кэш (planet|mode|size|v4)
// показал бы старый цвет («орбита старая, прогулка новая»).
const ImageGenVersion = "v5"
