...
// v10 (спека 2026-09-23 §4.9.8): заполнение color у 10 биомов экзотики (ЧК5)
// меняет и картинку планеты с орбиты — без бампа дисковый кэш
// (planet|mode|size|v9) показал бы старый цвет («орбита старая, прогулка новая»).
// v9 — тот же бамп для 5 биомов крио (ЧК4, §4.8.8); v8 — 7 биомов вулканизма
// (ЧК3, §4.7.5); v7 — 11 биомов биосферы (ЧК2, §4.6.5); v6 — 10 биомов
// литосферы (ЧК1, §4.5.5); v5 — 4 образца (§2.5).
const ImageGenVersion = "v10"
