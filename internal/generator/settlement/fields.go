...
var fieldSpecs = []FieldSpec{
	...
	},
	{
		...
		// составах); фактический минимум генератора ≈ 0.43 (выше страховки).
		// Максимум — плато насыщения гигантов (GasGiantRadiusMax).
		Key: "size", Label: "Радиус", Type: FieldNumber, Unit: "R⊕",
		Min: floatPtr(0.25), Max: floatPtr(11.2),
	},
	{
		// g = M/R²: страховка от пола массы 0.02 — 0.13; фактический минимум
		// генератора ≈ 0.33. Верх — гиганты 4131/11.2² = 32.9.
		Key: "gravity", Label: "Гравитация", Type: FieldNumber, Unit: "g",
		Min: floatPtr(0.13), Max: floatPtr(33),
	},
	{
