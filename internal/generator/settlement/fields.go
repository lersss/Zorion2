...
var fieldSpecs = []FieldSpec{
	...
	{
		// Физический каскад 0.02–8 (пол 0.02 — страховка реестра, генератором
		// не достигается; потолок 8 — граница ветки газовых гигантов),
		// гиганты до 4131 (GasGiantMassMax), экзотика 0.05–0.45. Спека
		// 2026-09-21 §5.3.
		Key: "mass", Label: "Масса", Type: FieldNumber, Unit: "M⊕",
		Min: floatPtr(0.02), Max: floatPtr(4131),
	},
	{
		// Страховка реестра от пола массы 0.02 (R = (M/ρ)^(1/3) при крайних
		// составах этапа 2 облака: обнажённое Fe-ядро ρ ≈ 1.40 →
		// (0.02/1.40)^(1/3) ≈ 0.2425); рамка 0.23 (было 0.25 — расширена
		// решением создателя 2026-09-22, спека облако-этап-2 §7.2). Запас
		// ≈ 5.2%. Максимум — плато насыщения гигантов (GasGiantRadiusMax).
		Key: "size", Label: "Радиус", Type: FieldNumber, Unit: "R⊕",
		Min: floatPtr(0.23), Max: floatPtr(11.2),
	},
	{
		// g = M/R²: страховка от пола массы 0.02 при крайних составах этапа 2
		// облака — обнажённый лёд ρ ≈ 0.30 → 0.02^(1/3)·0.30^(2/3) ≈ 0.1216;
		// рамка 0.12 (было 0.13 — расширена решением создателя 2026-09-22,
		// спека облако-этап-2 §7.2). Запас тонкий (≈ 1.3%). Верх — гиганты
		// 4131/11.2² = 32.9.
		Key: "gravity", Label: "Гравитация", Type: FieldNumber, Unit: "g",
		Min: floatPtr(0.12), Max: floatPtr(33),
	},
	{
	...
	},
	{
		...
		Values: []string{
			"газовый гигант", "мини-нептун", "радиоактивная", "землеподобная",
			"океаническая", "ледяная", "вулканическая", "пустынная", "стеклянная",
			"металлическая", "органик", "скалистая (базовая)",
		},
	},
	{
		...
		Values: []string{
			...
			"болота", "коралловые_рифы", "газовый_гигант", "мини-нептун",
		},
	},
	{
	...
	{
		// Класс (M_crit, 16] M⊕ (спека 2026-09-23 §11.2): зеркало is_gas_giant.
		Key: "is_mini_neptune", Label: "Мини-нептун", Type: FieldBool,
	},
