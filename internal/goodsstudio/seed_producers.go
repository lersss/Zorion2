...
// generation_config) в одной транзакции сеет 11 типов производителей
// (поселение, подтип «Обычное поселение», фабрика, автофабрика, добывающая
// платформа, энергостанция, лаборатория-родитель, 3 лаборатории-подтипа,
...
var seedProducers = []seedProducer{
	...
	// итерации 4 §5.2): нормы еды — структура params.eat в единой единице
	...
	{Name: "Обычное поселение", Kind: "goods", Parent: "Поселение", Output: `{}`, Input: `{}`, Params: `{"eat": {"вода": 600, "пища": 600, "продовольствие": 600}, "eat_units": "per_day_per_billion", "effects": {"продовольствие": "голод"}}`},
