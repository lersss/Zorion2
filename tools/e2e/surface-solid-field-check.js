...
function resolveViews() {
  ...
  const ids = ['горы', 'каменные_пустоши', 'пески_пустыни', 'джунгли', 'лавовые_поля', 'магмовый_океан', 'кратеры', 'пещерный_мир_с_потолком', 'ледники', 'кристальные_рощи',
    // ЧК6 — вода: тело жидкости в канвасе чанка (океаны/озёра) и ледовая корка
    // underIce (подлёдные_океаны) как часть поля твёрдости (§5.1).
    'океаны', 'озёра_реки', 'подлёдные_океаны', 'метановые_моря'];
  const out = [];
  for (const id of ids) {
