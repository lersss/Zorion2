...
// свип по набору seed и широкому окну x.
{
    const samples = [
        ...
        // ЧК4 — крио (§4.8.9 п.3: T-budget зелёный на всех 5).
        'ледники', 'мёрзлые_газы', 'сухой_лёд', 'инеевые_рощи', 'азотно-ледяная_тундра',
        // ЧК5 — экзотика (§4.9.9 п.3: T-budget зелёный на всех 10).
        ...
        // ЧК6 — вода (§A.2): T-budget зелёный на всех 10.
        'океаны', 'озёра_реки', 'мелководья_заливные', 'планктонные_моря',
        'термальные_террасы', 'метановые_моря', 'углеводородные_равнины',
        'аммиачные_крио-океаны', 'co2_океаны', 'подлёдные_океаны',
    ];
