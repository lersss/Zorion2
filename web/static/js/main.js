...
async function initMap() {
    ...
    await loadUserData();
    // Ленивый прелоад (спека 2026-09-23 §7.3, N6): греем ТОЛЬКО корабль
    // игрока; остальные спрайты рас догружаются при появлении агентов.
    preloadShipSprites(state.userShipIcon);
