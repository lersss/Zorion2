...
// 4-связность, достройка «лестницы» между waypoints, локальный «жар» трассы.
...
// «Лестница» с минимумом изломов: пока движемся по оси текущего направления
...
// stepHeat — локальный «жар» шага (§4.6): точечные метки на клетках пути.
