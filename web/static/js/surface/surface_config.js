...
// SHIP_DECOR_SIZE — мировой размер спрайта (игрок ≈28 px → ≈2.6 роста);
// SHIP_DECOR_X — смещение от спавна (0 = игрок ровно под кораблём: «меня
// только что сбросили»); SHIP_HOVER_BOTTOM — просвет под низом спрайта
// (≈4.5 роста игрока); покачивание — синус кадра (физику/ввод не трогает).
